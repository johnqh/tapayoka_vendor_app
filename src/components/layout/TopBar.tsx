        ...
        ? [
            {
              ...
              onClick: () =>
                navigate(
                  entitySlug
                    ? `/dashboard/${entitySlug}/locations`
                    : "/dashboard",
                ),
            },
            {
            ...
            },
            {
              ...
              onClick: () =>
                navigate(
                  entitySlug
                    ? `/dashboard/${entitySlug}/workspaces`
                    : "/dashboard",
                ),
            },
            {
            ...
            },
            {
              ...
              onClick: () =>
                navigate(
                  entitySlug
                    ? `/dashboard/${entitySlug}/invitations`
                    : "/dashboard",
                ),
              dividerAfter: true,
            },
